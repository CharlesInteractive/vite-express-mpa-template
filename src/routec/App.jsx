// Example page (Route C). The routea/routeb/routec folders are self-contained
...
export const meta = {
  title: "Route C · Vite + React + Tailwind CSS",
  description:
    "Route C — an example page in the Vite + React + Tailwind CSS multi-page template.",
};
